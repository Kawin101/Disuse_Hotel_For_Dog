...
from hotelfordog.mixins import(
	AjaxFormMixin, 
	reCAPTCHAValidation,
	FormErrors,
	RedirectParams,
...
class AccountView(TemplateView):
	# A Generic FormView with our mixin to display user account page
...
class SignInView(AjaxFormMixin, FormView):
	...
	# A Generic FormView with our mixin for user sign-in
...
def sign_out(request):
	# A Basic view for user sign out
